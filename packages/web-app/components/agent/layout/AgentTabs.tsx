...
export function AgentTabs({ activeTab, onTabChange }: AgentTabsProps) {
  return (
    <div
      className="flex items-center gap-0.5 px-4 border-b-[1.5px] border-pop-bd bg-pop-paper overflow-x-auto"
      role="tablist"
      ...
      {TAB_CONFIG.map((tab) => {
        ...
        return (
          <button
            ...
            className={cn(
              'flex items-center gap-2 rounded-t-lg px-4 py-2.5 text-sm border-b-[1.5px] -mb-[1.5px] transition-colors whitespace-nowrap',
              isActive
