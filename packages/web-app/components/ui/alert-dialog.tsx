...
function AlertDialogOverlay({
  ...
  return (
    <AlertDialogPrimitive.Overlay
      ...
      className={cn(
        // 与 Dialog 同款:遮罩零视觉遮挡,弹窗外区域 = 看板原样。
...
function AlertDialogAction({
  ...
  return (
    <AlertDialogPrimitive.Action
      className={cn(buttonVariants({ variant: 'pop' }), className)}
      {...props}
    />
  )
}
...
function AlertDialogCancel({
  ...
  return (
    <AlertDialogPrimitive.Cancel
      className={cn(buttonVariants({ variant: 'pop-quiet' }), className)}
      {...props}
    />
  )
}
