...
-- 无宿主；FK 保留）；+ source/trace_id/span_id（source 词表单源 @octopus/shared
-- LLM_CALL_SOURCE，见 all-sources-2 KD1；存量 NULL 由 v44 回填 'engine'；
-- trace_id=一轮聊天、span_id=单次 call 的 tracker messageId）。
