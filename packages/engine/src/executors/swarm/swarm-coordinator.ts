...
export interface CoordinatorDeps {
  llmCall: (prompt: string, model?: string, engine?: string, skills?: string[], tools?: string[], disallowedTools?: string[]) => Promise<{ text: string; model: string; tokens: number; inputTokens: number; outputTokens: number; toolsUsed: string[]; filesChanged: string[] }>
  hostAgent: HostAgent
