...
- **Idea 文档**: `.octopus/xzf/{feature}/01-idea.md`
- **Workspace 拓扑**: `.octopus/xzf/{feature}/workspace-topology.md`
- **预扫描结果**: `.octopus/xzf/{feature}/02-research/_scan/`
...
写入: `.octopus/xzf/{feature}/02-research/{domain}.md`
