...
- **Research Brief**: `.scratch/{feature}/01-research/research-brief.md`
...
写入: `.scratch/{feature}/02-clarification/feature-map.md`
...
写入: `.scratch/{feature}/02-clarification/features/F{N}-scope.md`
